...
def run_2L_backtest():
    ...
    print("=" * 60)
    print("SWING BACKTEST — Rs2,00,000 — 3 MONTHS — REGIME TAGGED")
    print("=" * 60)
    print()
    ...
    output_file = RESULTS_DIR / "swing_2L_3mo.json"
...
def print_summary(r: dict):
    ...
    print()
    print("=" * 60)
    print("OVERALL (Rs2,00,000 capital, 3 months)")
    print("=" * 60)
